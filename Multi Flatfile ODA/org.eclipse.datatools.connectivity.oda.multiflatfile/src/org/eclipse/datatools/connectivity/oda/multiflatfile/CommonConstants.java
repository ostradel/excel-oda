...
public final class CommonConstants
{
	...
	public static final String CONN_INCLALLFILES_PROP = "INCLALLFILES"; //$NON-NLS-1$
	public static final String CONN_FILENAMES_PROP = "FILENAMES"; //$NON-NLS-1$
	...
	public static final String DELIMITER_ANY = "ANY"; //$NON-NLS-1$
	public static final String DELIMITER_ANY_VALUE = "**"; //$NON-NLS-1$
	...
	public static final String FILE_EXTENSION_CSV = ".csv"; //$NON-NLS-1$
	public static final String FILE_EXTENSION_SSV = ".ssv"; //$NON-NLS-1$
	public static final String FILE_EXTENSION_PSV = ".psv"; //$NON-NLS-1$
	public static final String FILE_EXTENSION_TSV = ".tsv"; //$NON-NLS-1$
	...
	public static String getDelimiterValue( String delimiterName )
	{
		if ( delimiterName.equalsIgnoreCase( CommonConstants.DELIMITER_COMMA ) )
			...
			return CommonConstants.DELIMITER_ANY_VALUE;
	...
	public static boolean isValidDelimiterName( String delimiterName )
	{
		if ( delimiterName.equalsIgnoreCase( CommonConstants.DELIMITER_COMMA ) )
			...
			return true;
		else if ( delimiterName.equalsIgnoreCase( CommonConstants.DELIMITER_ANY ) )
			return true;
		else
			return false;
	}
